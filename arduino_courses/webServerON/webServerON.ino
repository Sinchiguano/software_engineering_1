...
String SendHTML(bool led1stat,bool led2stat,bool led3stat,bool led4stat){
  ...
  ptr +="<h4>ESTACION DE CONTROL DE LUCES</h4>\n";

  if(led1stat)
  {ptr +="<p>HALL Status: ON</p><a class=\"button button-off\" href=\"/led1off\">OFF</a>\n";}
  else
  {ptr +="<p>HALL:Status OFF</p><a class=\"button button-on\" href=\"/led1on\">ON</a>\n";}

  if(led2stat)
  {ptr +="<p>AULA 110 Status: ON</p><a class=\"button button-off\" href=\"/led2off\">OFF</a>\n";}
  else
  {ptr +="<p>AULA 110 Status: OFF</p><a class=\"button button-on\" href=\"/led2on\">ON</a>\n";}

  if(led3stat)
  {ptr +="<p>SECRETARIA Status: ON</p><a class=\"button button-off\" href=\"/led3off\">OFF</a>\n";}
  else
  {ptr +="<p>SECRETARIA Status: OFF</p><a class=\"button button-on\" href=\"/led3on\">ON</a>\n";}

  if(led4stat)
  {ptr +="<p>DECANATO Status: ON</p><a class=\"button button-off\" href=\"/led4off\">OFF</a>\n";}
  else
  {ptr +="<p>DECANATO Status: OFF</p><a class=\"button button-on\" href=\"/led4on\">ON</a>\n";}
